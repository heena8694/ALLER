...
<!--End Navigation-->
  ...
  <header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('vendor/img/back_hero1.jpg')">
        </div>
        <!-- Slide Two - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('vendor/img/img1.jpg')">
        </div>
        <!-- Slide Three - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('vendor/img/why_ride_with_us.jpg')">
        </div>
  ...
  <div class="container">
    ...
    <h1 class="my-4">Welcome to ALLER</h1>
