...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-6">
        <img class="img-fluid rounded mb-4" src="vendor/img/img5.JPG" alt="">
      </div>
      <div class="col-lg-6">
        <h2>About Us</h2>
        <p>
            ALLER is a system build to deal with problems faced in
            ...
            maintenance of the vehicles in terms of finance and time consumption.ALLER 
